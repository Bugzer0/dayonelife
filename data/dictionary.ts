...
const dictionary = {
  ...
  home: {
    ...
    description:
      'Habits, countdowns, streaks, and self-improvement insights.',
    newsletterTitle: 'Get new articles delivered to your inbox',
  ...
  // App banner
  appBanner: {
    title: 'Build Better Habits — Track Your Streaks',
    description: 'Set goals, build streaks, and transform your life one habit at a time.',
