...
```
https://dayonelife.app,https://www.dayonelife.app,https://dayonelife.pages.dev
```
...
1. **CORS:** Default cho phép `dayonelife.app` và `*.pages.dev`. Tùy chỉnh qua `ALLOWED_ORIGINS`
